...
public class FeatureToggleController {
    ...
    public ResponseEntity<FeatureToggleWeb> archive(@RequestBody ReleaseWeb releaseWeb) {
        log.info("New release requested: {}", releaseWeb.getVersionId());
        Set<FeatureToggleWeb> releaseList = releaseService.archive(releaseWeb);
        return new ResponseEntity(archivedList, HttpStatus.CREATED);
    }
